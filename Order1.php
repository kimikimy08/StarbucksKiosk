                                    ...
                                    <div class="accordion-body">
                                        <div class="Add" style="padding-bottom: 1rem;">
                                            ...
                                            <select class="form-select" name="Milk" aria-label="Default select example">
                                                ...
                                                ?>
                                                        <option selected><?php echo $item2['sub_cat'] ?? " "; ?></option>
                                                <?php
                                        ...
                                        <div class="row" style="padding-bottom: 1rem;">
                                            <div class="col text-center d-grid gap-2">
                                                <select class="form-select" name="Flavor" aria-label="Default select example">
                                                    ...
                                                    <?php
                                                    $additional_array = $menu->getOrderId($menu->getData('additional'));
                                                    foreach ($menu->join() as $item2) :

                                                        $result = $menu->getMenu($item2['cat_id']);
                                                      
                                                            if ($item2['category'] == 'syrup') {

                                                    ?>
                                                                <option value="Brown-Sugar-Syrup"><?php echo $item2['sub_cat'] ?? " "; ?></option>
                                        ...
                                        <div class="row" style="padding-bottom: 1rem;">
                                            <div class="col text-center d-grid gap-2">
                                                <select class="form-select" name="Sauces" aria-label="Default select example">
                                                    ...
                                                    ?>
                                                            <option value="Mocha-Sauce"><?php echo $item2['sub_cat'] ?? " "; ?>
